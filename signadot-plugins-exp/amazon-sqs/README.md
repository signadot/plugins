...
helm install amazon-sqs-plugin signadot-plugins-exp/amazon-sqs
```
...
this plugin by specifying the plugin name `amazon-sqs` and passing the following
input parameters.
...
```sh
helm uninstall amazon-sqs-plugin
```
